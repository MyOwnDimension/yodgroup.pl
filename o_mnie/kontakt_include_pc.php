...
<script type="text/javascript" src= "../noindex/pl/it/scripts/contact-20240916.js">

			</script>


			<form action="./?kontakt#kontakt_1" method="post"> 
			<center>
...
echo "<img src='./img_emailContact.php' alt='Email Kontaktowy Yod Group' style='width:200px;height:110px;'>";
?>
			</td>
			</tr>
...
// ."Content-Type: text/html; charset=utf-8 \r\n";
  ...
  echo '<p class="emailInfo">Formularz nieaktywny. Proszę użyć adresu email.</p><br><br>';
