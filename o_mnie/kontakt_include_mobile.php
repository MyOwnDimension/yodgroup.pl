...
echo "<img src='./img_emailContact_mobile.php' alt='Email Kontaktowy Yod Group' style='width:500px;height:275px;'>";
?>
			</td>
			</tr>
...
// ."Content-Type: text/html; charset=utf-8 \r\n";
  ...
  echo '<p class="emailInfoMobile">Formularz nieaktywny. Proszę użyć adresu email.</p><br><br>';
