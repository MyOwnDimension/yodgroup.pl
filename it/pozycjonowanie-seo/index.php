...
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?doswiadczenie" >'."\r\n";
...
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?zastosowanie" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["cele"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?cele" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["etapy"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?etapy" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["seo_optymalizacja"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?seo_optymalizacja" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["seo_etapy"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?seo_etapy" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["monitorowanie"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?monitorowanie" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

}else if (isset($_GET["kontakt"])) {
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/?kontakt" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";

} else{
echo '<TITLE>Automatyzacja procesów w firmie - Yod Group</TITLE>'."\r\n";
echo '<link rel="canonical" href="http://yodgroup.pl/it/pozycjonowanie-seo/" >'."\r\n";
echo '<meta name="keywords" content="automatyzacja procesów, redukcja kosztów, automat, praca, program, aplikacja">'."\r\n";
echo '<meta name="description" content="Oferujemy automatyzację procesów w firmie za pomocą wyspecjalizowanych aplikacji, co wpływa na redukcję kosztów i usprawnienie pracy">'."\r\n";
