...
$toemail1 = "website@rozwojfirmy.com";
...
?>
    ...
    echo '<text style=" color: red">Podaj adres email lub telefonu kontaktowego</text>';
} else {
...
$mail->Mailer = "smtp";
//$mail->Host = "smtp.yodstudio.com";
$mail->Host = "wn01.webd.pl";

$mail->SMTPAuth = true;
$mail->Username = "website@rozwojfirmy.com";
$mail->Password = "SfE5^2GrDw";
$mail->Port = 465;


$mail->From="website@rozwojfirmy.com";
$mail->FromName="WebSite";
$mail->Sender="website@rozwojfirmy.com";
$mail->AddReplyTo("website@rozwojfirmy.com", "");
$mail->ConfirmReadingTo="website@rozwojfirmy.com";

//$mail->AddBCC("backup@yodstudio.com", $name = '') ;

$mail->AddAddress($toemail1);
$mail->Subject = $subject1;

$mail->IsHTML(true);
$mail->Body = $messageReady;

$mail->AltBody="ALT BODY ale przynajmniej jest, spr to";


 $mail->Send();
  echo "<font color='red'><b>Error</b></font><br>".$mail->ErrorInfo;
 /*
if(!$mail->Send())
{
   echo "<font color='red'><b>Error</b></font><br>".$mail->ErrorInfo;
...
/*
	...
	*/
			...
			<table style="width: 90%; border: 0px solid;">
			<tr height='40' >
			<td align='center'>  
			...
			<td align='center'>  
			<label for="inputEmail">Email nadawcy:</label><br>  
